...
public class UserPermissionEvaluator implements PermissionEvaluator {
    ...
    public boolean hasPermission(Authentication authentication, Object targetUrl, Object permission) {
        ...
        List<UserPermissions> userPermissionsList = sysUserService.findPermissionsListByUserId(selfUserEntity.getUserId());
        for (UserPermissions userPermission :userPermissionsList) {
